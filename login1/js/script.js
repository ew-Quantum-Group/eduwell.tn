  // Disable right-click
        ...
        document.addEventListener('DOMContentLoaded', function () {
            ...
            if (eduwell_isAuthenticated()) {
                ...
                window.location.href = sessionStorage.getItem('eduwell_redirect_url') || '../profile/index.html';
                return;
            }
            ...
            loginForm.addEventListener('submit', function (e) {
                ...
                setTimeout(() => {
                    ...
                    if (result.success) {
                        ...
                        setTimeout(() => {
                            const redirectUrl = sessionStorage.getItem('eduwell_redirect_url') || '../profile/index.html';
